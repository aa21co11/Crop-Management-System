...
// Initialize crops array in session if not exists
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (isset($_POST['add_crop'])) {
        $new_crop = [
            'id' => max(array_column($_SESSION['crops'], 'id')) + 1,
        ...
        array_push($_SESSION['crops'], $new_crop);
    ...
    if (isset($_POST['update_crop'])) {
        ...
        foreach ($_SESSION['crops'] as &$crop) {
            if ($crop['id'] == $id) {
                ...
                $crop['crop_type'] = $_POST['crop_type'];
...
$irrigation_due = 2; // Hardcoded for demo
?>
...
<body>
            ...
            <div class="card-body">
              <ul class="list-group list-group-flush">
                <li class="list-group-item d-flex justify-content-between align-items-center">
                  <span>Wheat irrigation completed</span>
                  <small class="text-muted">2 hours ago</small>
                </li>
                <li class="list-group-item d-flex justify-content-between align-items-center">
                  <span>Pest detected in Rice field</span>
                  <small class="text-muted">1 day ago</small>
                </li>
                <li class="list-group-item d-flex justify-content-between align-items-center">
                  <span>Soybean harvest completed</span>
  ...
  <!-- Footer -->
  <footer class="text-white py-4" style="background-color: var(--accent);">
    <div class="container text-center">
      <p class="mb-0">© 2023 Farm Management System. All rights reserved.</p>
    </div>
  </footer>
  ...
  <!-- Dashboard Scripts -->
  <script>
    // Initialize edit modal with crop data
    ...
    // Initialize view modal with crop data
    document.querySelectorAll('.view-crop').forEach(button => {
      button.addEventListener('click', function() {
        ...
        document.getElementById('view_planting_date').textContent = new Date(this.getAttribute('data-planting')).toLocaleDateString();
        
        const harvestDate = this.getAttribute('data-harvest');
        document.getElementById('view_harvest_date').textContent = harvestDate ? 
          new Date(harvestDate).toLocaleDateString() : 'Not set';
        
        document.getElementById('view_area').textContent = this.getAttribute('data-area') ? 
          this.getAttribute('data-area') + ' acres' : 'Not specified';
    ...
    const growthChart = new Chart(growthCtx, {
      type: 'bar',
      data: {
        labels: ['Wheat', 'Rice', 'Corn', 'Soybean', 'Potato', 'Tomato'],
        datasets: [{
          label: 'Growth Progress (%)',
          data: [75, 60, 20, 100, 45, 80],
          backgroundColor: [
            '#4a7c7c',
            '#70a1a1',
            '#9abfbf',
